...
public interface JobSeekerService {
    void updateContactInfo(ContactInfoDto body, String userId);
    JobSeeker updateInfo(UpdateInfoDTO updateInfoDTO, String userId);
    void updateAvatar(String url, String userId);
    void updateResume(String url, String userId);
