...
public class EnterpriseService {
    ...
    public Enterprise signup(SignupEDTO en) {
        ...
        Enterprise newEnterprise = enterpriseRepository.save(new Enterprise(enterprise_name, email, password, "https://res.cloudinary.com/dz9kynjwb/image/upload/v1717770585/OIP_bsmlku.jpg", null, 0));
    ...
    public Enterprise getEnterpriseProfile(String eid) {
        Enterprise enterprise = enterpriseRepository.findByEid(Integer.parseInt(eid));
        return enterprise;
    }
